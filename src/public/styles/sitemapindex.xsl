...
.url:hover
{
  ...
  <body>
	<div id="content">
		...
		<p class="expl">This sitemap contains <xsl:value-of select="count(s:sitemapindex/s:sitemap)"/> URLs. Table below is sorted by update date. All columns are sortable, click on them to sort or change order.</p>
